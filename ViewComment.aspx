<%@ Page Title="" Language="C#" MasterPageFile="~/StaffPage.Master" AutoEventWireup="true" CodeBehind="ViewComment.aspx.cs" Inherits="MasterDesign.WebForm13" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <style>
     ...
     <div style=" background-color:burlywood; height: 467px; width: 1434px; margin-left: 37px; height: 520px; margin-top: 10px;">
        ...
        <br />
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="CM_ID" DataSourceID="SqlDataSource1" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" CssClass="auto-style2" Height="392px" Width="1248px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Description" SortExpression="Description" >
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("Description") %>' CssClass="text"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="Label1" runat="server" Text='<%# Bind("Description") %>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle Width="250px" CssClass="text" />
                    </asp:TemplateField>
                </Columns>
