<%@ Page Title="" Language="C#" MasterPageFile="~/StaffPage.Master" AutoEventWireup="true" CodeBehind="ViewTopicPage.aspx.cs" Inherits="MasterDesign.WebForm4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div style=" background-color:burlywood; height: 467px; width: 1434px; margin-left: 37px; height: 520px; margin-top: 10px;">
        ...
        <br />
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="FT_ID" DataSourceID="SqlDataSource1" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" CssClass="auto-style2" Height="259px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="1248px">
                <Columns>
